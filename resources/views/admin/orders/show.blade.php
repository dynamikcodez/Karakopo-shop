                        ...
                        <li class="py-4 flex items-center justify-between gap-4">
                            <div class="flex items-center space-x-4">
                                <div class="w-16 h-16 rounded-xl bg-gray-50 flex-shrink-0 overflow-hidden border border-gray-200">
                                    @php
                                        $itemImg = $item->product ? $item->product->image_url : asset('images/logo.png');
                                    @endphp
                                    <img src="{{ $itemImg }}" onerror="this.onerror=null;this.src='{{ asset('images/logo.png') }}';" class="w-full h-full object-cover" alt="{{ $item->name }}">
                                </div>
                                <div>
